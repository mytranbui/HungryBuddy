...
10.times do
  Foodplace.create(name: Faker::Restaurant.name,\
     address: Faker::Address.full_address, cuisine: Faker::Food.ethnic_category, \
     phone_number: Faker::PhoneNumber.phone_number_with_country_code ,\
     category: categories.sample, website: Faker::Internet.url,\
     google_rating: rand(1..5), opening_times:"8:00 - 18:00")
end
